...
public class CameraOperation : MonoBehaviour {
    ...
    void DesktopInput()
    {
        ...
        if (mx != 0 || my != 0)
        {
            ...
            {
                Camera.GetComponent<Camera>().transform.Translate(new Vector3(mx * Time.deltaTime, my * Time.deltaTime, 0));
            }
        }
    }
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                if (touch.phase == TouchPhase.Moved)
                {
                    ...
                    else
                    {
                        ...
                        Camera.GetComponent<Camera>().transform.Translate(0, 0, mov * Time.deltaTime);
                    }
